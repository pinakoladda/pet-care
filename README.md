...
-скролл в попапах
-скрол в попапах внутри самого попапа
-попап прозрачный внизу settings page
-дата добавления корма в будущем пофиксить
-сортировка добавленной еды одной даты в списке previous food
-знак зодиака в pet info
